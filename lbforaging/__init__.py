...
for s, p, f, mfl, c, po in product(sizes, players, foods, max_food_level, coop, partial_obs):
    register(
        id="Foraging{4}-{0}x{0}-{1}p-{2}f{3}{5}-v2".format(s, p, f, "-coop" if c else "", "-2s" if po else "", "-ind" if mfl else ""),
