...
class LBForagingEnv(gym.Env):
    ...
    def step(self, actions):
        """
        Processes a step in discrete time
        :param actions: a joint action
        :return:
        ...
        obs_n = [self._make_obs(player) for player in self.players]
        reward_n = [None for player in self.players]
        done_n = [self._game_over for _ in self.players]
        info_n = [None for _ in self.players]
